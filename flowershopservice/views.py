...
from flowershopservice.models import Product, DeliveryTimeSlot
import datetime
from django.shortcuts import render, redirect

from django.http import JsonResponse
from django.views.decorators.http import require_POST
from flowershopservice.models import ShopUser, Consultation, FlowerShop
import uuid


def contacts(request):
    shops = FlowerShop.objects.all()
...
def order(request):
    ...
    for slot in regular_slots:
        ...
        time_diff = datetime.datetime.combine(datetime.date.today(),
                                              slot.time_end) - datetime.datetime.combine(
